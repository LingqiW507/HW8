...
namespace ZooManager
{
    public static class Game
    {
        ...
        //this method is called in Mature method from Chick class.
        static public void ReplaceAnimal(Animal beginAnimal, Animal replacedAnimal)
        {//find the animal zone at the same location as the beginAnimal,
         //then replace the occupant in that zone with replacedAnimal. 
            animalZones[beginAnimal.location.y][beginAnimal.location.x].occupant = replacedAnimal;
        }
        static public void DuplicateAnimal(Animal beginAnimal, Animal duplicatedAnimal, Direction d)
        {
            int x = beginAnimal.location.x;
            int y = beginAnimal.location.y;
            switch (d)
            {
                case Direction.up:
                    y--;
            ...
            animalZones[y][x].occupant = duplicatedAnimal;
        }
        ...
        static public void AddAnimalToHolding(string animalType)
        {
            ...
            if (animalType == "alien") holdingPen.occupant = new Alien("Exotic");
